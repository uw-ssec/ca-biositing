"""Update mv_usda_county_production grain and logic

Revision ID: 386622baae98
Revises: 281cd66ca431
Create Date: 2026-03-24 09:39:02.865015
...
revision: str = '386622baae98'
down_revision: Union[str, Sequence[str], None] = '281cd66ca431'
...
def downgrade() -> None:
    """Downgrade schema."""
    op.execute("DROP MATERIALIZED VIEW IF EXISTS data_portal.mv_usda_county_production CASCADE")
    # Note: Downgrade to previous state would require the old SQL definition here,
    # but typically we just drop and recreate as needed in this project's workflow.
