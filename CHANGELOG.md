...
This project does not yet use versioned releases — all changes appear under **Unreleased**.
...
- PyPI releases for `ca-biositing-datamodels`, `ca-biositing-pipeline`, and `ca-biositing-webservice` namespace packages (#151)
- Seed admin user via Pulumi and Cloud Run job (#175)
- GCP staging deployment automation via GitHub Actions (#189)
- API discovery endpoints for analysis, USDA Census, and USDA Survey families, returning available crops, resources, geoids, and parameters (#170)
...
- GHCR images routed through Artifact Registry remote repository for reliability (#193)
...
[Unreleased]: https://github.com/sustainability-software-lab/ca-biositing/compare/HEAD...HEAD
