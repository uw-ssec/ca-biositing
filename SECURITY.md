...
1. **GitHub Security Advisories (preferred):** Use the
   [private vulnerability reporting](https://github.com/sustainability-software-lab/ca-biositing/security/advisories/new)
...
This project is maintained by a small academic research team. We will respond as
promptly as we can and appreciate your patience.
...
- We ask that you do not publicly disclose the vulnerability until a fix is
